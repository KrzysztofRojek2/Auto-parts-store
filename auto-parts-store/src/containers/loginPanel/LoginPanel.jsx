...
const LoginPanel = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      const transactionResponse = await fetch(`http://localhost:8080/api/transaction/ongoing/${data.userId}`, {
        method: 'GET',
      });
  ...
  return (
    <div className='login-panel'>
      ...
      <form onSubmit={handleSubmit}>
        ...
        {/* <p>Don't have an account? <span className=" login-panel__register-option bolder">Register</span></p> */}
      </form>
    </div>
  );
}
