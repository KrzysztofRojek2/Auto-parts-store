...
//        // Pobierz część i transakcję na podstawie identyfikatorów
...
//
//        // Dodaj część do transakcji
//        transaction.getParts().add(part);
//
...
//    }
    ...
    @Override
    public PartDto updatePartImg(Long id, String img) {
        Part part = partRepository.findById(id).orElseThrow(() -> new PartNotFoundException("Part could not be found"));
        part.setImage(img);
        partRepository.save(part);
        return mapPartToDto(part);
