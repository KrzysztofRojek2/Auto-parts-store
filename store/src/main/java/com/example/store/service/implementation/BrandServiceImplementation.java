...
//    @Override
//    public BrandResponse getAllBrands(int pageNo, int pageSize) {
//        Pageable pageable = PageRequest.of(pageNo, pageSize);
//        Page<Brand> brands = brandRepository.findAll(pageable);
//        List<Brand> listOfBrands = brands.getContent();
//        List<BrandDto> content = listOfBrands.stream().map(p -> mapToDto(p)).collect(Collectors.toList());
//
//        BrandResponse brandResponse = new BrandResponse();
//        brandResponse.setBrands(content);
//        brandResponse.setPageNo(brands.getNumber());
